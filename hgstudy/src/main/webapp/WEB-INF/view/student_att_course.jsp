...
<body>
	...
	<div class="panel panel-default course-history">
			...
			<div class="row">
				<c:forEach var="course" items="${pagebean.contents}">
					<div class="row course-list">
						<div class="col-sm-4">
							<a href="selectCourseInfor?couid=${course.couId}" target="_parent"><img class="img-responsive"
		...
		<ul class="pagination">
			<li><a href="showAttCourse?curpage=1">首页</a></li>

			<c:if test="${pagebean.curPage>1}">
				<li><a href="showAttCourse?curpage=${pagebean.curPage-1}"
			...
			<c:forEach begin="${pagebean.star}" end="${pagebean.end}" var="i">
				...
				<c:if test="${pagebean.curPage!=i}">
					<li><a href="showAttCourse?curpage=${i}" aria-label="Next">
			...
			<c:if test="${pagebean.curPage<pagebean.pageCount}">
				<li><a href="showAttCourse?curpage=${curpage+1}"
					aria-label="Next"> <span aria-hidden="true">&raquo;</span>
				</a></li>
			</c:if>
			<li><a href="showAttCourse?curpage=${pagebean.pageCount}">末页</a></li>
		</ul>
		</nav>
		</c:if>
	</div>
