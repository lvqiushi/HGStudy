        ...
        <div class="col-xs-3  head-img">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <a href="#avatar-modal" data-toggle="modal" id="student-head-btn"><img class="img-rounded" id="studentHeader" src="header/${stu.stuImage}"></a>
                </div>
                <div class="col-md-6">
                	<br>
                    <h4>${stu.stuName }</h4>
                    <h5>${stu.stuSchool }</h5><br>
                </div>
            </div>
            <div class="info-btn">
                <a type="button" id="bio-btn"  onclick="click2('${stu.stuId}')"  class="btn btn-default btn-block">编辑信息</a><br>
...
<script>
	...
	function click2(userid) {
		$("#student-iframe").attr("src","showStuInfor?stuid="+userid)
	}
	function click3() {
		 $("#student-iframe").attr("src","showAttCourse")
	}
